...
if [ "${schema_type}" == "DOCDB" ]; then
  ...
  sh "mongo --ssl --host $mongo_host:27017 --sslCAFile /home/centos/catalogue/rds-combined-ca-bundle.pem --username $user_name --password $password <schema/catalogue.js"
fi